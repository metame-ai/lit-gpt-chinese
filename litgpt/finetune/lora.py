...
def setup(
    ...
    fabric.launch(main, devices, seed, config, data, checkpoint_dir, 
                  out_dir, train, eval, save_merged_lora)
...
def main(
    ...
    system_message = getattr(data.train_dataset, "system_message", None)
    fabric.print(f"System message: {system_message}")
    ...
    if fabric.global_rank == 0:
        ...
        merge_lora(checkpoint_dir=save_path.parent, 
                   save_merged_lora=save_merged_lora)
