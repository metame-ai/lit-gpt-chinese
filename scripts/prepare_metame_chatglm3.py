...
DESTINATION_PATH = Path("data/metame")
...
class SupervisedDataset():
    ...
    def __init__(
        ...
        self.system_tokens = [tokenizer.token_to_id("<|system|>")]
    ...
    def preprocessing(self, example):
        ...
        if len(self.system_message):
            sys_msg = self.tokenizer.encode(self.system_message, return_tensor=False)
            new_tokens = self.system_tokens + newline_token + sys_msg
        ...
        for message in example["conversations"]:
            ...
            if from_ == "human":
                ...
                labels += [self.ignore_index]*len(self.assistant_tokens+newline_token) + value_ids
